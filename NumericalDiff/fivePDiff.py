...
def five_point_differentiation(f, x, h=1e-5):
    """
    Approximate the derivative of a function at a point using five-point differentiation.
...
if __name__ == "__main__":
    ...
    # Perform five-point differentiation and store intermediate results
    results = []
    x0 = a
    while x0 <= b:
        estimated_derivative = five_point_differentiation(user_function, x0, step_size)
